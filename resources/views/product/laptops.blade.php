...
<div class="wrapper">
    <div class="wrapper">
        ...
        <div class="content-area prodcuts">
            <div class="row">
                <div class="container">
                    @include('layouts.laptopNavigationBar')
                    <div class="col-sm-10 col-md-10 col-lg-10">
                        ...
                        <div class="all-products">
                            <div class="">
                                <h2 class="title-div wow slideInRight" data-wow-duration="1s" data-wow-delay="0s" data-wow-offset="10"><?php if(count($_GET) === 1 && isset($_GET['type'])) { echo "Our latest ".strtoupper($_GET['type'])."S are:";} else {echo "Your filtered results: ";}?></h2>
                                <div class="products">
                                    <div class="row">
