<div class="col-sm-2 col-md-2 col-lg-2">
    <div class="sidebar-products-main">
        ...
        <a role="button" href="{{route('Movies')}}">Reset filters</a>
        ...
        <div class="sidebar-single">
            ...
            <div id="typeCollapse" class="collapse out">
                <br>
                <a role="button" onclick="addOrReplace('type','movie-action')"><span></span>Action</a><br />
                <br>
                <a role="button" onclick="addOrReplace('type','movie-comedy')"><span></span>Comedy</a><br />
                <br>
                <a role="button" onclick="addOrReplace('type','movie-documentary')"><span></span>Documentary</a><br />
                <br>
                <a role="button" onclick="addOrReplace('type','movie-thriller')"><span></span>Thriller</a><br />
                <br>
                <a role="button" onclick="addOrReplace('type','movie-fitness')"><span></span>Fitness</a><br />
                <br>
                <a role="button" onclick="addOrReplace('type','movie-animation')"><span></span>Animation</a><br />
                <br>
                <a role="button" onclick="addOrReplace('type','movie-fantasy')"><span></span>Fantasy</a><br />
                <br>
                <a role="button" onclick="addOrReplace('type','movie-romance')"><span></span>Romance</a><br />
                <br>
                <div class="clearfix"></div>
            </div>
        </div>
